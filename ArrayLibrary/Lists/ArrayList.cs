...
namespace ArrayLibrary
{
    ...
    {
        private const double ArrayCoefficient = 1.33;
        private const int DefaultSizeArray = 5;
        private int[] _array;
        ...
        public ArrayList()
        {
            _array = new int[DefaultSizeArray];
            _currentCount = 0;
        }
        ...
        public ArrayList(int[] array)
        {
            ...
            int size = (int)(array.Length * ArrayCoefficient);
            size = size != 0 ? size : DefaultSizeArray;
            _array = new int[size];
        ...
        private void UpdateSize(int countToAdd = 1)
        {
            ...
            {
                int newSize = (int)((_array.Length + countToAdd) * ArrayCoefficient);
